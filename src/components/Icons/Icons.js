export function IconMessage({ classes, width = '2.6rem', height = '2.6rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
export function IconsInbox({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
//Icon SideBar
export function HomeIcon({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
export function HomeIconActive({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
export function UseGroupIcon({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
export function UseGroupIconActive({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
export function DiscoverIcon({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
export function DiscoverIconActive({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
export function LiveIcon({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
...
export function LiveIconActive({ classes, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            className={classes}
            width={width}
